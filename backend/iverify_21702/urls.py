"""iverify_21702 URL Configuration
...
admin.site.site_header = "Iverify"
admin.site.site_title = "Iverify Admin Portal"
admin.site.index_title = "Iverify Admin"

# swagger
api_info = openapi.Info(
    title="Iverify API",
    default_version="v1",
    description="API documentation for Iverify App",
)
